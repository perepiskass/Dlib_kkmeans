...
/**
 * @brief Функция создания точек вокрук центра определенного радиуса.
 */
void get_circle(points& samples,const long num, const double radius,const double offset_x = 0,const double offset_y = 0);

/**
 * @brief Функция создания произвольных точек в двумерном пространстве в диапазоне от -100 до 100.
 */
void get_starsky(points& samples,const long num);

/**
 * @brief Функция создания файла с координатами точек.
 */
